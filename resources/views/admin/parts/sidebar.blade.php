<div class="admin-side-bar-top">
            ...
            <ul>
                <li><a href=""><i class="ri-dashboard-line"></i>Dashboard<i class="ri-add-box-line"></i></a>
                    <ul class="sub-menu">
                        <div class="sub-menu-items">  <li><a href="/admin"><i class="ri-arrow-right-circle-fill"></i>Tổng quan</a>
                        </li></div>
                ...
                <li><a href=""><i class="ri-arrow-right-s-fill"></i></i>Đơn hàng<i class="ri-add-box-line"></i></a>
                    ...
                    <div class="sub-menu-items">  
                        <li><a href="/admin/oder/list"><i class="ri-arrow-right-circle-fill"></i>Danh sách</a>
                    </li></div>
